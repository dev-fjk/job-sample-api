...
public class ResumeListSelector {
    ...
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
    @Parameter(description = "入社日 終了指定 entryDateより過去日は設定不可", schema = @Schema(type = "string"))
    ...
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
    @Parameter(description = "応募日 終了指定 2022-07-15を指定した場合 2022-07-15 23:59:59までに応募したユーザーが対象となる", schema = @Schema(type = "string"))
